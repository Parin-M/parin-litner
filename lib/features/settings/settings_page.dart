    ...
    await showDialog<void>(
      ...
      builder: (dialogContext) => StatefulBuilder(
        builder: (dialogContext, setDialogState) {
          ...
          final list = AppSettings.languages.where((item) {
            return q.isEmpty || '${item.nativeName} ${item.name} ${item.code}'.toLowerCase().contains(q);
          }).toList();
          return AlertDialog(
              ...
              child: Column(
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(hintText: s('search'), prefixIcon: const Icon(Icons.search_outlined)),
                  ),
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) => Scaffold(
        ...
        body: ListView(
          ...
          children: [
            _Section(title: s('language'), icon: Icons.language_outlined, child: ListTile(
            ...
            _Section(title: s('appearance'), icon: Icons.palette_outlined, child: Column(
                      ...
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text('${index + 1}. ${theme.name}', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 11)),
                          ]),
                        ),
                      );
                    },
